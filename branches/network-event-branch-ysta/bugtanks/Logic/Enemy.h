 ...
 */
	Enemy(double hp,double damage,Sizes size,int aiStyle,int range);
/**
 * Deconstructor
 */
	~Enemy();
...
/**
 * Function that calculates the damage done by enemies to the driver
 */
	virtual void calculateDamage(/*event*/);
/**
