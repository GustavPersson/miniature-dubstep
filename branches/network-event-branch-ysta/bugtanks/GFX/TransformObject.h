...
namespace gfx
{
	...
	class TransformObject : public RenderObject
	{
		public:
			 ...
			 */
			inline const float &getScaleX() const {return mScale.x;}

			/**
			 * Retrieves the Y scale modifier.
			 * @return Returns mScale.y.
			 */
			inline const float &getScaleY() const {return mScale.y;}

			/**
			 * Retrieves the Z scale modifier.
			 * @return Returns mScale.z.
			 */
			inline const float &getScaleZ() const {return mScale.z;}
			 ...
			 */
			inline const float &getRotationX() const {return mRotation.x;}

			/**
			 * Retrieves the Y axis rotation.
			 * @return Returns mRotation.y.
			 */
			inline const float &getRotationY() const {return mRotation.y;}

			/**
			 * Retrieves the Z axis rotation.
			 * @return Returns mRotation.z.
			 */
			inline const float &getRotationZ() const {return mRotation.z;}
