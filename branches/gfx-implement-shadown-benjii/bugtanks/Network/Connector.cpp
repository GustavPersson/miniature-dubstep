...
void* Connector::socketFunc(void *args)
{
	...
	{
		cout << "ERROR(Connector::socketFunc): pthread_setcancelstate -> PTHREAD_CANCEL_ENABLE" << endl;
	}
	if(pthread_setcanceltype (PTHREAD_CANCEL_ASYNCHRONOUS, NULL))
	{
		cout << "ERROR(Connector::socketFunc): setcanceltype -> PTHREAD_CANCEL_ASYNCHRONOUS" << endl;
	}
