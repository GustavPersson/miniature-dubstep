...
BufferObject::BufferObject(ID3D10Device *pDevice, Effect *pEffect) : TransformObject(pDevice, pEffect)
{
	...
	setRenderPass(ShaderPasses::CEL);
...
void BufferObject::createEmptyVertexBufferStatic()
{
	...
	{
		DEBUG_MESSAGE("Error: GFX: BufferObject: createEmptyVertexBufferStatic(). Error creating vertex buffer.")
	}
}
...
void BufferObject::createEmptyVertexBufferDynamic()
{
	...
	{
		DEBUG_MESSAGE("Error: GFX: BufferObject: createEmptyVertexBufferDynamic(). Error creating vertex buffer.")
	}
}
...
void BufferObject::createEmptyIndexBuffer()
{
	...
	{
		DEBUG_MESSAGE("Error: GFX: BufferObject: createEmptyIndexBuffer(). Error creating index buffer.")
	}
}
