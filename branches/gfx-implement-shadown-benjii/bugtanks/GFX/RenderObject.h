...
namespace gfx
{
	...
	class RenderObject
	{
		public:
			 ...
			 * @param shadows New value for mFlagShadows
			 */
			 ...
			 */
			virtual inline void setRenderPass(int index) { mRenderPassIndex = index; }
			 ...
			 */
			inline const bool &getFlagShadow() const {return mFlagShadow;}

			/**
			 * Returns the shader pass used for rendering
			 */
			inline const unsigned int &getRenderPass() const { return mRenderPassIndex; }
