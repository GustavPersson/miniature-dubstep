...
#ifndef INSTANCE_SHAPE_CUBE_H
#define INSTANCE_SHAPE_CUBE_H
#include "InstanceObject.h"

namespace gfx
{
	/**
	 * Class for instanced cube shapes.
	 */
	class InstanceShapeCube : public InstanceObject
	{
		public:
			/**
			 * Default constructor.
			 ...
			 */
			InstanceShapeCube(ID3D10Device *pDevice, Effect *pEffect);

			/**
			 * Default copy constructor.
			 */
			InstanceShapeCube(const InstanceShapeCube &cube);

			/**
			 * Default destructor.
			 */
			virtual ~InstanceShapeCube();

			/**
			 * Default assignment operator.
			 */
			const InstanceShapeCube &operator=(const InstanceShapeCube &cube);
