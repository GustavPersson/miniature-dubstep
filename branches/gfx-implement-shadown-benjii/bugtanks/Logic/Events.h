...
{
	explicit EvtData_System_MouseMove(long mouseX, long mouseY,
	...
	virtual EventDataPtr copy() const
	{
		return EventDataPtr(myNew EvtData_System_MouseMove(mMouseX, mMouseY));
	}
...
{
	explicit EvtData_From_ActorCreated(int actorId, const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: BaseEventData(timeStamp)
	{
		mId = actorId;
	}
...
{
	explicit EvtData_From_ActorDestroyed(int actorId, const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: BaseEventData(timeStamp) 
	{
		mId = actorId;
	}
...
{
	explicit EvtData_From_EnemyHit(const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: EmptyEventData(timeStamp)
	{
	}
...
{
	explicit EvtData_From_WeaponFired(const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: EmptyEventData(timeStamp)
	{
	}
...
{
	explicit EvtData_To_ActorStartMove(int actorID, bool forward, const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: BaseEventData(timeStamp) 
	{
		mId = actorID;
		mForward = forward;
...
{
	explicit EvtData_To_ActorStopMove(int actorID, bool forward, const float timeStamp = GlobalTimer::getInstance()->getTime(utilities::Timer::ReturnType_MilliSeconds))
		: BaseEventData(timeStamp) 
	{
		mId = actorID;
		mForward = forward;
