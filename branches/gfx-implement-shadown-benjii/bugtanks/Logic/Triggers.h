...
/**
 * Trigger classes that send one type of event each.
 */
	...
	class TriggerCreateGroup : public TriggerBase
	{
		public:
			/**
			 * Default constructor.
			 ...
			 * Default copy constructor.
			 */
			TriggerCreateGroup(const TriggerCreateGroup &trigger);

			/**
			 * Default destructor.
			 */
			virtual ~TriggerCreateGroup();

			/**
			 * Default assignment operator.
			 */
			const TriggerCreateGroup &operator=(const TriggerCreateGroup &trigger);
