...
const EventType EvtData_System_MouseMove::mEventType("mouse_move");
const EventType EvtData_System_MouseKeyDown::mEventType("mouse_key_down");
const EventType EvtData_System_MouseKeyUp::mEventType("mouse_key_up");
//From-Events
