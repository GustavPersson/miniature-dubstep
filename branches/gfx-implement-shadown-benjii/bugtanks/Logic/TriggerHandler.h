...
namespace logic
{
	...
	class TriggerHandler : public EventListener
	{
		public:
			 ...
			 */
			inline const std::vector<BV *> &getActiveBVList() const {return mActiveBVList;}
			 ...
			 * @return A vector with pointers to the triggers' bounding volumes.
			 */
			inline const std::vector<BV *> &getCompletedBVList() const {return mCompletedBVList;}

			/**
			 * Returns a boost::shared_ptr of this object.
			 *  Used for registering this object as an event listener.
			 * @return boost::shared_ptr<TriggerHandler>(this).
			 */
			inline const EventListenerPtr &getEventListenerPointer() const {return mEventListenerPointer;}
