...
{	
	...
	//half timePerFrame = (half)Animations.Load(float4( 1, 0, animationIndex, 0));
	...
	if(input.Weights.x > 0.1h)
	{
		...
		{
			tempMatrix[0][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 0, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 0, frameIndex + 1, animationIndex, 0));
			tempMatrix[0][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 1, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 1, frameIndex + 1, animationIndex, 0));
			tempMatrix[0][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 2, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 2, frameIndex + 1, animationIndex, 0));
			tempMatrix[0][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 3, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 3, frameIndex + 1, animationIndex, 0));
			tempMatrix[1][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 4, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 4, frameIndex + 1, animationIndex, 0));
			tempMatrix[1][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 5, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 5, frameIndex + 1, animationIndex, 0));
			tempMatrix[1][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 6, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 6, frameIndex + 1, animationIndex, 0));
			tempMatrix[1][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 7, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 7, frameIndex + 1, animationIndex, 0));
			tempMatrix[2][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 8, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 8, frameIndex + 1, animationIndex, 0));
			tempMatrix[2][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 9, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 9, frameIndex + 1, animationIndex, 0));
			tempMatrix[2][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 10, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 10, frameIndex + 1, animationIndex, 0));
			tempMatrix[2][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 11, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 11, frameIndex + 1, animationIndex, 0));
			tempMatrix[3][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 12, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 12, frameIndex + 1, animationIndex, 0));
			tempMatrix[3][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 13, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 13, frameIndex + 1, animationIndex, 0));
			tempMatrix[3][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 14, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 14, frameIndex + 1, animationIndex, 0));
			tempMatrix[3][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 15, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 15, frameIndex + 1, animationIndex, 0));
		}
		else
		{
			tempMatrix[0][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 0, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 0, 1, animationIndex, 0));
			tempMatrix[0][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 1, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 1, 1, animationIndex, 0));
			tempMatrix[0][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 2, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 2, 1, animationIndex, 0));
			tempMatrix[0][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 3, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 3, 1, animationIndex, 0));
			tempMatrix[1][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 4, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 4, 1, animationIndex, 0));
			tempMatrix[1][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 5, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 5, 1, animationIndex, 0));
			tempMatrix[1][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 6, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 6, 1, animationIndex, 0));
			tempMatrix[1][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 7, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 7, 1, animationIndex, 0));
			tempMatrix[2][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 8, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 8, 1, animationIndex, 0));
			tempMatrix[2][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 9, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 9, 1, animationIndex, 0));
			tempMatrix[2][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 10, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 10, 1, animationIndex, 0));
			tempMatrix[2][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 11, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 11, 1, animationIndex, 0));
			tempMatrix[3][0] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 12, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 12, 1, animationIndex, 0));
			tempMatrix[3][1] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 13, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 13, 1, animationIndex, 0));
			tempMatrix[3][2] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 14, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 14, 1, animationIndex, 0));
			tempMatrix[3][3] = w2 * (half)Animations.Load(float4( jointIndex * 16 + 15, frameIndex, animationIndex, 0)) + w1 * (half)Animations.Load(float4( jointIndex * 16 + 15, 1, animationIndex, 0));	
		}
