...
ParticleSmallExplosion::ParticleSmallExplosion(ID3D10Device *pDevice, Effect *pEffect, char* name, int techIndex, int passIndex, int initParticles, int maxChildParticles) 
