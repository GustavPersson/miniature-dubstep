...
namespace gfx
{
	...
	class Camera
	{
		public:
			/**
			 * Constructor,
			 * @param width Width of the orthogonal projection.
			 * @param height Height of the orthogonal projection.
			...
			/**
			 * Sets Camera offset (by vector)
			 * @param pos Vector containing offset positions
			 */
			...
			void rotationDirection(int direction);
