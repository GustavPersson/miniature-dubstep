...
Particle::Particle(ID3D10Device *pDevice, Effect *pEffect, char* name, int techIndex, int passIndex, int initParticles, int maxChildParticles)
{
	mName				= name;
	mpDevice			= pDevice;
	mpEffect			= pEffect;
	...
	mParticleType		= -1;
	mEffectTechIndex	= techIndex;
	mEffectPassIndex	= passIndex;
	mEffectLayoutIndex	= passIndex;
