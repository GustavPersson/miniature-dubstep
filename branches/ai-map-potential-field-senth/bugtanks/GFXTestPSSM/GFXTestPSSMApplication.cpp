...
void GFXTestPSSMApplication::createObjects()
{
	...
	safeQueueEvent(EventDataPtr(myNew EvtData_To_ActorCreateTank(logic::Tank::TankType_CloseCombat, utilities::Position(50.0f, 3.0f, 0.0f + (40.0f * mpPlayerInfo->getNetworkId())),utilities::Direction(1.0f,0.0f,0.0f), Actor::PlayerMovingInfo())));
