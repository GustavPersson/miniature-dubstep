...
namespace logic
{
	...
	class TriggerCreateUnit : public TriggerBase
	{
		public:
			...
			/**
			 * Retrieves the number of objects that should be created.
			 * @return Returns mCreateCount.
			 */
			inline int getCreateCount() const {return mCreateCount;}

			/**
			 * Sets the number of objects that should be created.
			 * @param count New value for mCreateCount.
			 */
			inline void setCreateCount(int count){mCreateCount = count;}
