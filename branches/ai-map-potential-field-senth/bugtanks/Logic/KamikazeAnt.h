...
#ifndef __KAMIKAZEANT_H__
#define __KAMIKAZEANT_H__
...
class KamikazeAnt:public Enemy
{
 ...
 * @param radius the blast radius of the kamikaze ants explosion
 * @param pos the position of this actor
 * @param dir the direction of this actor
 */
	KamikazeAnt(int networkId, utilities::Position pos, utilities::Direction dir);
/**
 * Deconstructor
 */
	~KamikazeAnt();
 ...
 */
	void attack();
/**
 * update position for kamikaze ant
 ...
 */
	std::string getName(void) {return "KamikazeAnt";}
	static std::string getEnemyName(void) {return "KamikazeAnt";}
