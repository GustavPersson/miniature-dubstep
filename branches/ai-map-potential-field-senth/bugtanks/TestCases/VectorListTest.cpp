...
public:
 TestDescription_VectorListTest_testRemoveFirst() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 97, "testRemoveFirst" ) {}
...
public:
 TestDescription_VectorListTest_testRemoveLast() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 113, "testRemoveLast" ) {}
...
public:
 TestDescription_VectorListTest_testChangeValue() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 129, "testChangeValue" ) {}
...
public:
 TestDescription_VectorListTest_testMax() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 143, "testMax" ) {}
 void runTest() { suite_VectorListTest.testMax(); }
} testDescription_VectorListTest_testMax;

static class TestDescription_VectorListTest_testGetFirstAndLast : public CxxTest::RealTestDescription {
public:
 TestDescription_VectorListTest_testGetFirstAndLast() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 159, "testGetFirstAndLast" ) {}
 void runTest() { suite_VectorListTest.testGetFirstAndLast(); }
} testDescription_VectorListTest_testGetFirstAndLast;

static class TestDescription_VectorListTest_testClear : public CxxTest::RealTestDescription {
public:
 TestDescription_VectorListTest_testClear() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 171, "testClear" ) {}
 void runTest() { suite_VectorListTest.testClear(); }
} testDescription_VectorListTest_testClear;

static class TestDescription_VectorListTest_testExceptions : public CxxTest::RealTestDescription {
public:
 TestDescription_VectorListTest_testExceptions() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 194, "testExceptions" ) {}
 void runTest() { suite_VectorListTest.testExceptions(); }
} testDescription_VectorListTest_testExceptions;

static class TestDescription_VectorListTest_testRemove : public CxxTest::RealTestDescription {
public:
 TestDescription_VectorListTest_testRemove() : CxxTest::RealTestDescription( Tests_VectorListTest, suiteDescription_VectorListTest, 219, "testRemove" ) {}
 void runTest() { suite_VectorListTest.testRemove(); }
} testDescription_VectorListTest_testRemove;
