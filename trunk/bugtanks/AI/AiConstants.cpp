...
// Potential field
int AiConstants::POTENTIAL_BUILDING_RANGE = 1;
float AiConstants::POTENTIAL_BUILDING_START_VALUE = 1.5f;
int AiConstants::POTENTIAL_WIDTH_AGENT = 19;
int AiConstants::POTENTIAL_WIDTH_PLAYER = 49;
...
// Update
float AiConstants::UPDATE_TIME_AGENT = 0.025f;
...
// Pheromones
const float AiConstants::PHEROMONE_START_VALUE = 3.0f;
const float AiConstants::PHEROMONE_DECREASE_VALUE = 1.0f;
