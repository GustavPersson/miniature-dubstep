...
namespace gfx
{
	...
	class ObjectHandler
	{
		public:
			 ...
			 * Retrieves an instance base.
			 * @param instanceID ID of the instance base to retrieve.
			 * @return Returns a pointer to the instance base.
			 */
			 ...
			 * @param pInstance Pointer to the instance base to add.
			 */
			void addGUIInstanceBase(InstanceSprite *pInstance);
			 ...
			 * @return Returns a pointer to the instance base.
			 */
			InstanceSprite *getGUIInstanceBase(int instanceID);
			 ...
			 * @return Returns a pointer to the instance base.
			 */
			InstanceSprite *getGUIInstanceBase(const char *instanceName);

			/**
			 * Removes (deletes) an instance base.
			 * @param instanceID ID of the instance to remove.
			 */
			void removeGUIInstanceBase(int instanceID);

			/**
			 * Removes (deletes) an instance base.
			 * @param instanceName Name of the instance to remove.
			 */
			void removeGUIInstanceBase(const char *instanceName);

			/**
			 * Removes (deletes) all instance bases.
			 */
			void removeAllGUIInstanceBases();

			/**
			 * Retrieves all mesh and object instance bases.
			 * @param baseVector Outgoing vector with all instance bases.
			 */
			void getAllInstanceBases(std::vector<RenderObject *> &baseVector);
		...
		private:
			...
			std::vector<InstanceSprite *> mGUIInstanceList;
			QuadTree *mpQuadTree;
			Frustum *mpFrustum;
			Camera *mpCamera;
	};
