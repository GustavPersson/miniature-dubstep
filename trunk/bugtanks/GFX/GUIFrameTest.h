...
#ifndef GUI_FRAME_TEST_H
#define GUI_FRAME_TEST_H
#include "GUIImage.h"
...
namespace gfx
{
	class GUIFrameTest : public GUIImage
	{
		public:
			/**
			 * Default constructor.
			 ...
			 */
			GUIFrameTest(InstanceSprite *pBaseInstance, long clientWidth, long clientHeight, long parentDepth);

			/**
			 * Subframe constructor.
			 * @param pParent Pointer to the parent.
			 */
			GUIFrameTest(GUIFrame *pParent);

			/**
			 * Default copy constructor.
			 */
			GUIFrameTest(const GUIFrameTest &frame);

			/**
			 * Default destructor.
			 */
			virtual ~GUIFrameTest();

			/**
			 * Default assignment operator.
			 */
			const GUIFrameTest &operator=(const GUIFrameTest &frame);
