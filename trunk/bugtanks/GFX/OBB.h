...
public:
	 ...
	 */
	inline const D3DXVECTOR3 &getCorner(int index) const {return mCorners[index];}

	/**
	 * Returns a axis.
	 * @param index . The index of the axis.
	 */
	inline const D3DXVECTOR3 &getAxis(int index) const {return mAxis[index];}

	inline const D3DXVECTOR3 &getCornerAxis(int index) const {return mCornerAxis[index];}
	...
	inline float getOrigin(int index) const {return mOrigin[index];}
