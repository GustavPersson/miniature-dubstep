...
ParticleSmallExplosion::ParticleSmallExplosion(ID3D10Device *pDevice, Effect *pEffect, char* name, int passIndex, int layoutIndex, int initParticles, int maxChildParticles, int offset) 
...
void ParticleSmallExplosion::updateParticleStorage(ID3D10Resource* pParticleStorage)
{
...
void ParticleSmallExplosion::render()
{
	Particle::render();
}