...
namespace gfx
{
	...
	class DX10Module : public utilities::Thread
	{
		public:
			 ...
			 * @param filePath Absolute/relative file path to the MeshGeometry.btb file.
			 * @param mtrlFilePath Absolute/relative file path to MeshMaterial.btb file.
			...
			/**
			 * Loads an animated mesh geometry file and creates an instance base of the mesh model.
			 *  This instance base is not added to the normal mObjectList in the ObjectHandler.
			 *  All draw calls and updates of the derived instances are performed from the base.
			 * @param filePath Absolute/relative file path to the MeshGeometry.btb file.
			 * @param mtrlFilePath Absolute/relative file path to MeshMaterial.btb file.
			 * @param weightFilePath Absolute/relative file path to MeshWeights.btb file.
			 * @param instanceID ID to assign to the instance base.
			 * @param instanceName Name to assign to the instance base.
			 * @param maxInstances Maximum number of possible instances.
			 * @param updateFromBase Specifies if the instance base should update all instances each frame.
			 ...
			 * @param maxInstances Maximum number of possible instances.
			 */
			void loadObjectShapeInstance(RenderObject::ShapeTypes type, int instanceID, const char *instanceName, unsigned int maxInstances);
			...
			/**
			 * Loads and stores an animation.
			 *  The index of the the stored animation can then be retrieved by calling getAnimationIndex().
			 * @param animationFilePath Absolute/relative filepath of the animation file.
			 * @param animationName Name of the animation.
			 */
			void loadAnimation(const char *animationFilePath, const char *animationName);

			/**
			 * Retrieves the index in the animation texture array of a sought animation.
			 * @param animationName Name of the animation to retrieve.
			 * @return Returns in the index of the animation.
			 */
			...
			/**
			 * Removes (deletes) all RenderObjects.
			 *  Can not remove mesh models or instance bases.
			 */
			void removeAllRenderObjects();

			/**
			 * Removes (deletes) all InstanceObjects.
			 *  Can not remove mesh models or instance bases.
			 */
			void removeAllRenderInstances();

			/**
			 * Creates the world plane.
			 *  Removes the current world plane first if one exists.
			 * @param tileX Number of tiles along the X axis.
			 * @param tileZ Number of tiles along the Z axis.
			 * @param tileSizeX Size of each tile along the X axis.
			 * @param tileSizeZ Size of each tile along the Z axis.
			 */
