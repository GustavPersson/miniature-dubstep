...
{	
	...
	mpFXParticleTextureArray = mpEffect->GetVariableByName("ParticleTextureArray")->AsShaderResource();
...
void Effect::updateParticleTextureArray(ID3D10ShaderResourceView *pTexture)
{
	mpFXParticleTextureArray->SetResource(pTexture);
}
