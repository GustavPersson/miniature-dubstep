...
void Light::MatrixLookAtLH()
{
	...
	D3DXVECTOR3 target = mLight.pos + mLight.dir * 100.0f;
	D3DXMatrixLookAtLH(&mViewM, &mLight.pos, &target, &vY);
}

void Light::calcTargetVector(const D3DXVECTOR3 &target)
{
	mLight.dir = target - mLight.pos;
