 ...
 * @param ownerId the owner of the id
 */
	EnemyWeapon(float damage, float weaponCooldown, float range, const KeyType& ownerId);
/**
 * Destructor
 */
	virtual ~EnemyWeapon();
 ...
 * @param targetId the target we want to shoot at
 */
	virtual void fireWeapon(const KeyType& targetId) = 0;
/**
