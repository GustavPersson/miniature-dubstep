...
/**
 * Retrieves the unit's HP.
 * @return Returns mHealthPoints.
 */
	inline float getHealthPoints() const {return mHealthPoints;}

/**
 * Retrieves the unit's max HP.
 * @return Returns mHealthPointsMax.
 */
	inline float getHealthPointsMax() const {return mHealthPointsMax;}

protected:
	float mHealthPoints;
	float mHealthPointsMax;
	bool mFire;
