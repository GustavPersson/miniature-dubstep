 ...
 * @param position the acid spits origin
 * @param direction the acid spits direction
 ...
 */
	Acid(int networkId, utilities::Position position, utilities::Direction direction, int efficiency, float damage);
/**
 * Deconstructor
 */
	~Acid();
/**
 * update acid position
 * @param deltaTime the time between calls, used to calculate movement
 */
	void update(float deltaTime);

/**
 * handles various events related to acid
 ...
 */
	std::string getName(void) {return "Acid";}
