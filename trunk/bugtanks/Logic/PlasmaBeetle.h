...
#ifndef __PLASMABEETLE_H__
#define __PLASMABEETLE_H__
...
class PlasmaBeetle:public Enemy
{
 ...
 */
	PlasmaBeetle(int networkId, utilities::Position pos, utilities::Direction dir);
/**
 * Deconstructor
 */
	~PlasmaBeetle();
 ...
 */
	void attack();
/**
 * update position for plasma beetle
 ...
 */
	std::string getName(void) {return "PlasmaBeetle";}
	static std::string getEnemyName(void) {return "PlasmaBeetle";}
