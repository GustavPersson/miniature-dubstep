 ...
 * @param jumpRange the range a jumper can jump at you from
 */
	Jumper(int networkId, utilities::Position pos, utilities::Direction dir);
/**
 * Destructor
 */
	~Jumper();
 ...
 */
	std::string getName(void) {return "Jumper";}
	static std::string getEnemyName(void) {return "Jumper";}
