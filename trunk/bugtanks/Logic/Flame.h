 ...
 * @param position the flames origin
 * @param direction the flames direction
 ...
 */
	Flame(int networkId, utilities::Position position, utilities::Direction direction, int efficiency, float damage);
/**
 * Deconstructor
 */
	~Flame();
...
/**
 * handles various events related to flame
 ...
 */
	std::string getName(void) {return "Flame";}
};
}
