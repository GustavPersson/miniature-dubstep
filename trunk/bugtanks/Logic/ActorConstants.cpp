...
float ActorConstants::JUMPER_JUMP_TIME_MIN	= 0.0f;
float ActorConstants::JUMPER_JUMP_TIME_MAX	= 0.0f;
...
void ActorConstants::setConstants(const char *path)
{
	...
	JUMPER_JUMP_TIME_MIN = ::GetPrivateProfileFloat(
		"JUMPER_CONSTANTS", "Jumper_Jump_Time_Min", 0, path);

	JUMPER_JUMP_TIME_MAX = ::GetPrivateProfileFloat(
		"JUMPER_CONSTANTS", "Jumper_Jump_Time_Max", 0, path);
