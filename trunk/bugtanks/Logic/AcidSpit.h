...
#ifndef __ACIDSPIT_H__
#define __ACIDSPIT_H__

namespace logic 
{

/**
 * This is a subclass to enemy weapon, this is the black widows weapon
 */

class AcidSpit : public EnemyWeapon
{
 ...
 */
	AcidSpit(float damage, float weaponCooldown, float range, const KeyType& ownerId);
 ...
 */
	void fireWeapon(const KeyType& targetId);
