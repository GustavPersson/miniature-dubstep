 ...
 * @param direction the fire spits direction
 ...
 */
	Fire(int networkId, utilities::Position position, utilities::Direction direction, int efficiency, float damage);
/**
 * Deconstructor
 */
	~Fire();
 ...
 */
	std::string getName(void) {return "Fire";}
