...
namespace logic
{
	...
	class TriggerHandler : public EventListener
	{
		public:
			...
			/**
			 * Retrieves the TriggerHandler instance.
			 * @return Returns mpTriggerHandlerInstance.
			 */
			static TriggerHandler *getInstance();
			 ...
			 * @param ID ID of the trigger to activate.
			 * @return Returns true if a trigger was found and activated.
			 */
			bool forceTriggerActivation(int ID);

			/**
			 * Forces a trigger to be completed without triggering its activation.
			 * @param ID ID of the trigger to complete.
			 * @return Returns true if a trigger was found and completed.
			 */
			bool forceTriggerCompletion(int ID);
			 ...
			 * @param pTrigger Pointer to a trigger.
			 * @return Returns true if the trigger was removed.
			 */
			 ...
			 * @return Returns true if the trigger was removed.
			 */
			bool removeActiveTrigger(int ID);
			 ...
			 * @return Returns true if the trigger was removed.
			 */
			bool removeCompletedTrigger(int ID);
			...
			/**
			 * Adds all active and completed triggers to the supplied vector.
			 * @param triggers Outgoing reference to the trigger vector.
			 */
			void getAllTriggers(std::vector<TriggerBase *> &triggers);

			/**
			 * Retrieves a vector with all active triggers.
			 * @return Returns mActiveList.
			 */
			inline const std::vector<TriggerBase *> &getActiveTriggerList() const {return mActiveList;}

			/**
			 * Retrieves a vector with all completed triggers.
			 * @return Returns mCompletedList.
			 */
			inline const std::vector<TriggerBase *> &getCompletedTriggerList() const {return mCompletedList;}
		...
		protected:
			struct TriggerData
			{
				...
				TriggerData() : mSourcePosition(0.0f, 0.0f, 0.0f), mSourceRotation(0.0f, 0.0f, 0.0f),
		...
		private:
			...
			/**
			 * Deletes all pending triggers from the mDeleteTriggerStack.
			 */
			void deleteTriggers();

			static TriggerHandler *mpTriggerHandlerInstance;
			...
			std::stack<TriggerData> mCreateTriggerStack;
			std::stack<TriggerBase *> mDeleteTriggerStack;
			D3DXVECTOR3 mTriggerScale;
			int mAvailableID;
	};
}
