...
namespace logic
{
	...
	class TriggerBase
	{
		public:
			 ...
			 */
			virtual void forceActivation();

			/**
			 * Forces the trigger to be completed without triggering its activation.
			 */
			...
			/**
			 * Retrieves the activation requirement of the trigger.
			 * @return Returns mRequirement.
			 */
			inline int getRequirement() const {return mRequirement;}

			/**
			 * Retrieves the activation sub requirement of the trigger.
			...
			/**
			 * Retrieves the activation float value of the trigger.
			 * @return Returns mFloatValue.
			 */
			inline float getFloatValue() const {return mFloatValue;}

			/**
			 * Retrieves the activation float sub value of the trigger.
			 * @return Returns mFloatSubValue.
			 */
			inline float getFloatSubValue() const {return mFloatSubValue;}

			/**
			 * Retrieves the misc value of the trigger.
			 * @return Returns mMisc.
			 */
			inline int getMisc() const {return mMisc;}
			...
			/**
			 * Sets the integer misc value for the trigger.
			 *  Function varies depending on the trigger type.
			 * @param misc Misc value to set.
			 */
			inline void setMisc(int misc){mMisc = misc;}
