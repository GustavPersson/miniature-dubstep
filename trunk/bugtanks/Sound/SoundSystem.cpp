...
SoundSystem::SoundSystem() 
{
    ...
    */
    mResult = mpSoundSystem->set3DSettings(1.0f, 80.0f, 1.0f); // TODO: Tweak
    HandleError(mResult);
...
void SoundSystem::loadSounds()
{
	...
	//for 4 (the number of menu sounds) loops
	...
	//for every element in the mGameSounds vector, starting with 4 (or the number of menu sounds)
...
int SoundSystem::findActor( logic::KeyType actorID )
{
	...
	DEBUG_MESSAGE( LEVEL_LOW, "Sound Error: 60003 - No actor found with the provided actor ID\n" );
	return -1;
}
