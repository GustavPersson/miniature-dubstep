...
public:
	...
	*/
	...
	int findRotationSound( logic::KeyType actorID, bool turret );
	...
	/**
	 * Find the pActor accociated with the actorID
	 */
	 ...
	 * Changes the music
	 */ 
	void musicChanger( sound::Sounds sound );
...
private:
	...
	*/
	...
	std::vector<singleChannelInfo> mSingleChannels;
